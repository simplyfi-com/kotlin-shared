...
@Composable
fun Registration(navController: NavHostController, token: (String) -> Unit) {
    val client = Client(
        Config(
            stringResource(R.string.API_URL),
            ...
            Column {
                Button(
                    onClick = {
                        ...
                        secret = randomString(6, letters) + randomString(2, digits) + randomString(1, symbols)
